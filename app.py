...
<style>
    ...
    /* ══════════════════════════════════════════════════
       TOMBOL SIDEBAR — target via kind attribute
       (lebih kuat dari data-testid di Streamlit Cloud)
    ══════════════════════════════════════════════════ */
    ...
    /* Sembunyikan teks icon material */
    ...
    /* Ikon ☰ untuk tombol buka (di header) */
    ...
    /* Ikon ✕ khusus tombol tutup (di dalam sidebar) */
    ...
    /* ════════════════════════════════════════
       1. FONT GLOBAL — span dikecualikan agar
       tidak merusak icon material di expander
    ════════════════════════════════════════ */
    ...
    .stButton span, .stCaption span {
        font-family: 'Plus Jakarta Sans', sans-serif !important;
    }
    /* Sembunyikan teks icon di expander summary */
